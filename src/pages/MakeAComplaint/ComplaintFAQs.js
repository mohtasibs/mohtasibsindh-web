                ...
                <div className="row">
                    <div className="col-md-12 ms-md-5 pe-5">
                        ...
                        <div className="mt-4">
                            ...
                            <p className="values-system-para">We aim to redress grievances as fairly and quickly as possible and to deal with the complainant respectfully. Our Service Charter sets out our standards of service in detail.
                            </p>
                        </div>
                        <div className="mt-4">
