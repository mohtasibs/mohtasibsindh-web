        ...
        <div className="container">
            ...
            <div className="row">
              <div className="col-md-12  ">
                <h2 className="values-system-heading d-flex">
                  Official Contacts <FcApproval className="ms-3" />
                </h2>
          ...
          <table className="table">
            ...
            <tbody>
              ...
              <tr>
                <td className="col-xs-6">DR. KHALIL UR REHMAN</td>
              ...
              <tr>
                <td className="col-xs-6">MR. MUHAMMAD RIAZ GILL</td>
                <td className="col-xs-3">JR, CONSULTANT(FINANCE)</td>
              ...
              <tr>
                <td className="col-xs-6">IT SECTION</td>
                <td className="col-xs-3"></td>
