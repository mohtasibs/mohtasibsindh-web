                ...
                <table className="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td className="col-xs-3">99211021
                            </td>
                        </tr>
                        <tr>
                            <td className="col-xs-6">MR. JALALUDDIN MAHAR		</td>
                            <td className="col-xs-3">DIRECTOR GENERAL - I	</td>
                            <td className="col-xs-3">99211054</td>
                        </tr>
                        <tr>
                            <td className="col-xs-6">DR. ZULFIQAR ALI SHALLWANI	</td>
                        ...
                        <tr>
                            <td className="col-xs-6">SYED QAMAR RAZI NAQVI
                            </td>
                            <td className="col-xs-3">CONSULTANT - B</td>
                        ...
                        <tr>
                            <td className="col-xs-6">MR. MUKHTAR HUSSAIN SOOMRO</td>
                            <td className="col-xs-3">ADVISOR - I
                            </td>
                            <td className="col-xs-3">99211030
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td className="col-xs-3">LIBRARIAN	</td>
                        ...
                        <tr>
                            <td className="col-xs-6">STAFF OF MOHTASIB</td>
                            <td className="col-xs-3">	-</td>
                            <td className="col-xs-3">-</td>
                        </tr>
                        ...
                        <tr>
                            <td className="col-xs-6">STAFF OF ADVISOR-H
                            </td>
                            <td className="col-xs-3">-</td>
                            <td className="col-xs-3">-</td>
                        </tr>
                        ...
                        <tr>
                            <td className="col-xs-6">RECEPTION	</td>
                            <td className="col-xs-3">	-</td>
                            <td className="col-xs-3">-</td>
                        </tr>
                        <tr>
