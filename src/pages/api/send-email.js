                ...
                const mailOptions = {
                    ...
                    html: `
                        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
                            ...
                            <hr/>
                            <p><strong>Complaint Type:</strong> ${complaint.type ? complaint.type : 'Not Provided'}</p>
                            <p><strong>Complaint Office:</strong> ${complaint.complaintOffice}</p>
